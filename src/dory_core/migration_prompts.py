...
def build_classification_system_prompt() -> str:
    return (
        ...
        "Use entity and decision references in canonical ref form like person:primary-user, project:sample, concept:openclaw, decision:active-memory."
    )
...
def build_extraction_system_prompt() -> str:
    return (
        ...
        "Each atom must use canonical subject_ref syntax like person:primary-user or project:sample. "
