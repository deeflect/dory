...
def test_session_ingest_upserts_cleaned_log(tmp_path: Path) -> None:
    ...
    response = client.post(
        ...
        json={
            ...
            "content": "We decided Sample is the focus this week.",
            "agent": "claude",
            "device": "macbook",
            "session_id": "s1",
            "status": "active",
...
def test_session_ingest_does_not_trigger_full_reindex(tmp_path: Path) -> None:
    ...
    response = client.post(
        ...
        json={
            ...
            "content": "Changed project direction toward Sample registry MVP.",
            "agent": "codex",
            "device": "mac",
            "session_id": "s2",
            "status": "active",
...
def test_session_ingest_can_be_recalled_through_http_search(tmp_path: Path) -> None:
    ...
    ingest = client.post(
        ...
        json={
            ...
            "content": "We decided Sample is the active focus and cleaned up SOUL.",
            "agent": "claude",
            "device": "macbook",
            "session_id": "s3",
            "status": "active",
